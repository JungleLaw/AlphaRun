...
public class ScreenUtils {
    ...
    /**
     * 显示通知栏
     * <p>需添加权限 {@code <uses-cn.law.rethink.permission android:name="android.cn.law.rethink.permission.EXPAND_STATUS_BAR"/>}</p>
     *
     * @param context        上下文
    ...
    private static void invokePanels(Context context, String methodName) {
        try {
            ...
            Class<?> statusBarManager = Class.forName("android.android.support.v4.app.StatusBarManager");
