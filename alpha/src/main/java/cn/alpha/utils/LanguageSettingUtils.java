...
import cn.alpha.cache.DiskCache;
...
public class LanguageSettingUtils {
    ...
    public String getLanguage() {
        ...
        String language = DiskCache.getInstance(context).get("language");
        return TextUtils.isEmpty(language) ? this.defaultLanguage : language;
    }
    ...
    public void saveLanguage(String paramString) {
        ...
        DiskCache.getInstance(context).put("language", paramString);
    ...
    public void saveSystemLanguage() {
        ...
        DiskCache.getInstance(context).put("PreSysLanguage", this.defaultLanguage);
    }
    ...
    public void checkSysChanged(String cuerSysLanguage) {
        ...
        String language = DiskCache.getInstance(context).get("PreSysLanguage");
        if (TextUtils.isEmpty(language)) {
            language = "zh";
        }
        if (!cuerSysLanguage.equals(language)) {
