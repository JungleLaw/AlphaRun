...
public class SilentInstaller {
    ...
    /**
     * Installation return code<br/>
     * the package manager service found that the device didn't have enough storage space to install the android.support.v4.app.
     */
    ...
    /**
     * Uninstall return code<br/>
     * uninstall fail if cn.law.rethink.permission denied
     */
    ...
    /**
     * uninstall package and clear data of android.support.v4.app silent by root
     *
     * @param context
     * @param packageName package name of android.support.v4.app
     * @return
     ...
     * <li>You should add <strong>android.cn.law.rethink.permission.DELETE_PACKAGES</strong> in manifest, so no need to request root
     * cn.law.rethink.permission, if you are system android.support.v4.app.</li>
     * </ul>
     *
     ...
     * <li>{@link #DELETE_FAILED_PERMISSION_DENIED} means cn.law.rethink.permission denied</li>
     */
    public int uninstallSilent(Context context, String packageName, boolean isKeepData) {
        ...
        /**
         * if context is system android.support.v4.app, don't need root cn.law.rethink.permission, but should add <uses-cn.law.rethink.permission
         * android:name="android.cn.law.rethink.permission.DELETE_PACKAGES" /> in mainfest
         **/
     ...
     * <strong>Attentions:</strong>
     * <li>Don't call this on the ui thread, it may costs some times.</li>
     * <li>You should add <strong>android.cn.law.rethink.permission.INSTALL_PACKAGES</strong> in manifest, so no need to request root
     * cn.law.rethink.permission, if you are system android.support.v4.app.</li>
    ...
    public int installSilent(Context context, String filePath, String pmParams) {
        ...
        /**
         * if context is system android.support.v4.app, don't need root cn.law.rethink.permission, but should add <uses-cn.law.rethink.permission
         * android:name="android.cn.law.rethink.permission.INSTALL_PACKAGES" /> in mainfest
         **/
