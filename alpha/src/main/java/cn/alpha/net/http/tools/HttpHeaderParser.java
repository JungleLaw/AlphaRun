...
public class HttpHeaderParser {
    public static Cache.Entry parseCacheHeaders(boolean useServerControl, int cacheTime, NetworkResponse response) {
            ...
            for (String token : tokens) {
                ...
                if (token.equals("no-cache") || token.equals("no-store")) {
                    ...
                    try {
                        ...
                        Logger.d(HttpHeaderParser.class.getName() + e.getMessage());
                    }
