...
public class DownloadRequest extends Request<byte[]> {
    ...
    public DownloadRequest(String storeFilePath, RequestConfig config, HttpCallback callback) {
    ...
    public Response<byte[]> parseNetworkResponse(NetworkResponse response) {
        Logger.i("DownloadRequest parseNetworkResponse");
    ...
    public byte[] handleResponse(URLHttpResponse response) throws IOException {
        Logger.i("DownloadRequest handleResponse");
