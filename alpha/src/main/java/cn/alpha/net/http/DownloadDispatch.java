...
public class DownloadDispatch extends Thread {
    private final BlockingQueue<Request<?>> mDownloadQueue; // 用于执行网络请求的工作队列
     ...
     *
     * @param downloadQueue 正在执行的队列
     */
    public DownloadDispatch(BlockingQueue<Request<?>> downloadQueue, Network network, Cache cache, Delivery delivery) {
