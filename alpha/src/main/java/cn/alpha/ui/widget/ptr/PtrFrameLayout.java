package cn.alpha.ui.widget.ptr;
...
import cn.alpha.R;
import cn.alpha.ui.widget.ptr.indicator.PtrIndicator;
...
public class PtrFrameLayout extends ViewGroup {
    ...
    private void layoutChildren() {
        if (DEBUG) {
            //PtrCLog.v(LOG_TAG, "layoutChildren");
        }
    ...
    public boolean dispatchTouchEvent(MotionEvent e) {
        ...
        switch (action) {
            ...
            case MotionEvent.ACTION_CANCEL:
                //PtrCLog.d(LOG_TAG, "MotionEvent.ACTION_UP|ACTION_CANCEL");
            ...
            case MotionEvent.ACTION_DOWN:
                if (DEBUG) {
                    //PtrCLog.v(LOG_TAG, "ACTION_DOWN: Y:%s", e.getX());
                }
