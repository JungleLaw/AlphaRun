...
public class ThinkProgressBar extends View {
    ...
    private void initAttrs(Context context, AttributeSet attrs, int defStyleAttr) {
        final TypedArray mTypedArray = context.obtainStyledAttributes(attrs, R.styleable.ThinkProgressBar, defStyleAttr, 0);
        mCellLenght = mTypedArray.getDimensionPixelSize(R.styleable.ThinkProgressBar_cellLenght, (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_SP, 30, getResources().getDisplayMetrics()));
        mDivider = mTypedArray.getDimensionPixelSize(R.styleable.ThinkProgressBar_cellDivider, (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_SP, 10, getResources().getDisplayMetrics()));
        ...
        mDisplayTextSize = mTypedArray.getDimensionPixelSize(R.styleable.ThinkProgressBar_displayTextSize, (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_SP, 16, getResources().getDisplayMetrics()));
        mTypedArray.recycle();
    }
